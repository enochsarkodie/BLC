...
const testimonials = [
  { img: user_1, name: "Janet Opoku-Darkwa:", location: "Accra",  text: "They gave me my life back I was at my lowest point after my accident unable to work, buried in medical bills, and completely lost. The team at Black Law Consult didn’t just take my case, they took care of me. My scheduled attorney checked in regularly, remembered details about my family, and genuinely seemed invested in my recovery, not just my case. When we finally reached a settlement, I cried not just because of the outcome, but because I finally felt like someone had truly fought for me. I will be forever grateful." },
  { img: user_2, name: "Emmanuel Ntim",    location: "Tarkwa, Ghana",    text: "Divorce is devastating, and I was barely holding it together when I first got in touch with Black Law consult. I was surprised to have had the entire legal team at my side and they were patient, kind, and never once made me feel like just another case on their desk. They fought fiercely for my children while helping me stay grounded when emotions ran high. The compassion I was shown during such a painful chapter means more than I can express. I came out the other side with a fair outcome and my dignity intact. I owe that entirely to this incredible team" },
  { img: user_1, name: "Daniel Dadzie",    location: "Enchi, Ghana",     text: "As someone totally unknown to the law, facing criminal charges is terrifying, and I felt completely alone. From day one, my lawyers looked me in the eye and told me they would stand by me and they meant it. The relief I felt when the charges were dismissed is indescribable. This firm didn’t just defend me, they restored my faith that justice is possible. I cannot thank them enough" },
  { img: user_2, name: "Grace Salomey Nkansah", location: "Tema, Ghana",  text: "Black Law Consult handled our corporate dispute with remarkable efficiency. They kept us informed every step of the way. Truly a firm that puts clients first." },
  { img: user_1, name: "Samuel Gyamfi",    location: "Sekondi",     text: "Their availability alone sets them apart. They have an efficient 'back office' which will send you reminders on cases, dates for court appearances and all you need to know about the case. That level of dedication is incredibly rare." },
  { img: user_2, name: "David Yankey",     location: "Nkroful, Ghana",  text: "Black Law Consult a firm of friendly lawyers! " },
  { img: user_2, name: "James Gordon",     location: "Oslo, Norway",  text: "When I entered Black Law Consult, for a second I forgot I was in Ghana. The professionalism, warm reception and attitude towards satisfying clients was one for the books. They handled my issue with dispatch and I left fully satisfied" },
  { img: user_2, name: "Joseph Nyarko",     location: "Cape Coast",  text: "Even though I lost my case, I was comforted by their efforts in handling the case."},
]
